  ...
  <body>
    <div class="row" id="content">
      ...
      <div class="row">
            ...
            <a class="left carousel-control" href="#geocarousel" role="button" data-slide="prev" class="arrow">
              <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
              <span class="sr-only">Previous</span>
            </a>

            <a class="right carousel-control" href="#geocarousel" role="button" data-slide="next" class="arrow">
